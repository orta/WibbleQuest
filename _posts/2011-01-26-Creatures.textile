...
The way that the battle is described is quite interesting too, you supply a collection of strings in the form of an array that lets you describe each attack given and recieved, this means you dont have to have generic "you hit the hippogruff for 5 damage" messages, you can make your own up. Like below.
